...
const Hero = () => {
    ...
    return (
        <section ref={container} className="relative pt-32 pb-48 px-6 lg:px-12 overflow-hidden bg-zinc-950 text-white">
            <div className="max-w-screen-2xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    {/* Left Column: Text Content */}
                    <div className="lg:col-span-7 flex flex-col items-start text-left relative z-10 text-white">
                        <div ref={subTitleRef} className="flex items-center space-x-4 mb-8">
                            <span className="section-label mb-0 italic">Est. 2024</span>
                            <div ref={lineRef} className="h-[1px] w-12 bg-zinc-800"></div>
                            <span className="text-xs font-medium text-zinc-400 tracking-wide">Journal of thoughts</span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row items-end justify-between w-full border-t border-zinc-900 pt-12">
                            <p className="text-lg md:text-xl text-zinc-400 max-w-md leading-relaxed mb-12 lg:mb-0">
                    ...
                    {/* Right Column: HeroRight Component */}
